...
GLOBAL	VOID Set_CloudBSILockMode( BOOL flag );
GLOBAL	BOOL Get_IsCloudBSILockMode( VOID );
GLOBAL	VOID Set_CloudBSIMsgSendtoPanelFlag( BOOL flag );

GLOBAL VOID SerioUIJobCompulsiveCancel( VOID );
